...
// moreCars.forEach(arrayElement => {
//     if (arrayElement.make === "Ford") console.log(`${arrayElement.make} ${arrayElement.model}
//     with ${arrayElement.mileage} miles.`);
// });

function sortCarArray(carsArray) {
    return carsArray.sort((a, b,)=> {
        const el1 = a.make.toLowerCase();
        const el2 = a.make.toLowerCase();
        if (el1 < el2) {
            return -1;
        } else if (el1 > el2) {
            return 1;
...
// my code
// let make = "pov"
// let nameLength = make.length;
// if (make = ford model = type) {
// } else if (mileage = miles) {
//     console.log(type="ford")
// }
